...
Monte Carlo methods are used to then simulate multiple possible stints in the same race to see the variance of possibilities, hypothetically enabling strategy decisions.
